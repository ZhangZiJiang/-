 ...
 * @description:
 * @author: zhangbo
 * @create: 2021/01/19 18:35
 */

// 本试卷唯一 ID: 19C939209BE876DB4B8B82F2AC84E280, 请勿修改本行内容
/* 注意, 这里不要写包名. 留空 */
    ...
    public static Set<String> showMap(Map<String, Object> map) {
        ...
        for (String s : map.keySet()) {
            ...
            if (obj instanceof String || obj instanceof Number) {
                ...
                showMap(strings, str, (Map<String, Object>) obj);
            } else {
                showArray(strings, str, (Object[]) obj);
            }
            num++;
        }
        return strings;
